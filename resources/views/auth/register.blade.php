...
<body>
    <section id="banner" style="background-image: url('images/bg/bg-1.jpg');">
      <div class="container text-light" style="height: 500px;">
        <div class="row">
          <div class="col-4">
          </div>
          <div class="col-4">
            <div class="sign-up-form bg-primary">
              ...
              <div class="form-wrapper border-top border-secondary" style="">
                <form action="{{ route('register') }}" method="post">
                  ...
                  <div class="form-group m-3">
                    <input type="text" name="name" class="form-control rounded" id="example-name" placeholder="Enter name">
                  </div>
                  <div class="form-group m-3">
                  ...
                  <div class="col text-center">
                    <button class="btn-dark rounded-pill">Signup</button>
                  </div>
                </form>
              </div>
              <div class="text-center">
                  <a class="text-light" href="{{ route('login') }}">Already have an account?</a>
                </div>
